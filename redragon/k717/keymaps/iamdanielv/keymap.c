 ...
 */
    [BASE_LYR] = LAYOUT(
       MY_GRV,    KC_1,      KC_2,      KC_3,      KC_4,      KC_5,      KC_6,      KC_7,      KC_8,      KC_9,      KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,
       KC_TAB,    KC_Q,      KC_W,      KC_E,      KC_R,      KC_T,      KC_Y,      KC_U,      KC_I,      KC_O,      KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,
       MO_CAPS,   KC_A,      KC_S,      KC_D,      KC_F,      KC_G,      KC_H,      KC_J,      KC_K,      KC_L,      KC_SCLN,  KC_QUOT,  _______,  MY_ENT,
       KC_LSFT,   KC_NUBS,   KC_Z,      KC_X,      KC_C,      KC_V,      KC_B,      KC_N,      KC_M,      KC_COMM,   KC_DOT,   KC_SLSH,  _______,  UP_RSFT,
       KC_LCTL,   KC_LGUI,   KC_LALT,                                    KC_SPC,                                     ARWS_RALT,KBCTL_LFT,DN_APP,   RCTL_RGT
    ),
    [HRM_BASE_LYR] =  LAYOUT(
       ...
       _______,   GUI_A,     ALT_S,     SFT_D,     CTL_F,     CTLG_G,    _______,   CTL_J,     SFT_K,      ALT_L,    HM_SCLN,  END_QUOT, _______,  _______,
       LSFT_LLCK, _______,   _______,   _______,   CTLS_C,    _______,   _______,   _______,   _______,    ALFT_COMM,ARGT_DOT, _______,  _______,  _______,
    ...
    [EXT_LYR] = LAYOUT(
       ...
       _______,   KC_LGUI,   KC_LALT,   KC_LSFT,   KC_LCTL,   C(KC_G),   KC_PGDN,   KC_LEFT,   KC_DOWN,    KC_RIGHT, KC_HOME,  KC_END,   END_QUOT, _______,
       LSFT_LLCK, _______,   MY_UNDO,   MY_CUT,    MY_COPY,   MY_PASTE,  KC_SPC,    KC_BSPC,   KC_DEL,     MY_BACK,  MY_FWD,   _______,  _______,  KC_VOLU,
       _______,   _______,   _______,                                    KBCTL_SPC,                                  _______,  MY_BACK,  KC_VOLD,  MY_FWD
    ),
    [KBCTL_LYR] = LAYOUT(
       ...
       LSFT_LLCK, _______,   TD_KB_CLR, XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   NK_TOGG,   XXXXXXX,   RM_VALD,   RM_VALU,  TG_EXT,   _______,  TG_HRM,
       KC_SWP_FN, _______,   _______,                                    XXXXXXX,                                    TG_ARWS,  _______,  TG_NUM,   QK_LLCK
    ),
    [NUM_LYR] = LAYOUT(
       ...
       LSFT_LLCK, XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   KBCTL_SPC, _______,   KC_P0,     KC_PDOT,   KC_PDOT,  KC_PSLS,  _______,  _______,
       _______,   _______,   _______,                                    KBCTL_SPC,                                  _______,  _______,  QK_LLCK,  _______
    ),
    [ARROW_LYR] =  LAYOUT(
       _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,  _______,  _______,  KBCTL_BSPC,
       _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,  _______,  _______,  _______,
       _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,  _______,  _______,  _______,
       LSFT_LLCK, _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,   _______,  _______,  _______,  KC_UP,
...
//   uint8_t palette_index = PALETTEFX_AFTERBURN;  // Set afterburn palette
